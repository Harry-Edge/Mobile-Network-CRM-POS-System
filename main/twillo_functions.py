...
from secret_keys import account_sid_key, auth_token_key, from_number, to_number
...
def send_sim_only_order_information(cus_order):
    insurance = ""
    try:
...
def send_handset_order_information(cus_order):
